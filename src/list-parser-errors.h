...
PARSE_ERROR(INVALID_COLOR,			"invalid color")
...
PARSE_ERROR(INVALID_ITERATE,		"invalid power calculation iteration")
...
PARSE_ERROR(NO_FILE_FOUND,			"file not found")
PARSE_ERROR(NO_KIND_FOR_EGO_TYPE,	"no object kind found for ego type")
PARSE_ERROR(NO_KIND_FOUND,			"object kind not found")
PARSE_ERROR(NO_ROOM_FOUND,			"room not found")
...
PARSE_ERROR(UNRECOGNISED_BLOW,		"unrecognised blow")
PARSE_ERROR(UNRECOGNISED_BRAND,		"unrecognised brand")
PARSE_ERROR(UNRECOGNISED_SLAY,		"unrecognised slay")
PARSE_ERROR(UNRECOGNISED_CURSE,		"unrecognised curse")
PARSE_ERROR(UNRECOGNISED_TRAP,		"unrecognised trap")
PARSE_ERROR(UNRECOGNISED_TVAL,		"unrecognised tval")
PARSE_ERROR(UNRECOGNISED_SVAL,		"unrecognised sval")
PARSE_ERROR(UNRECOGNISED_PARAMETER,	"unrecognised parameter")
PARSE_ERROR(VAULT_TOO_BIG,			"vault too big")
PARSE_ERROR(VAULT_DESC_WRONG_LENGTH,"wrong length for vault description line")
