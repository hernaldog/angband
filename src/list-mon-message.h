...
MON_MSG(CRINGE_LIGHT,		MSG_GENERIC,	false,	"cringe[s|] at the light!")
MON_MSG(SHRIVEL_LIGHT,		MSG_KILL,		false,	"shrivel[s|] in the light!")
...
MON_MSG(MORE_DAZED,			MSG_GENERIC,	false,	"[is|are] even more dazed.")
MON_MSG(DAZED,				MSG_GENERIC,	false,	"[is|are] dazed.")
MON_MSG(NOT_DAZED,			MSG_GENERIC,	false,	"[is|are] no longer dazed.")
...
MON_MSG(MORE_SLOWED,		MSG_GENERIC,	false,	"look[s|] slower.")
MON_MSG(SLOWED,				MSG_GENERIC,	false,	"look[s|] slower.")
...
MON_MSG(HELD,				MSG_GENERIC,    false,  "[is|are] paralyzed in place!")
MON_MSG(NOT_HELD,			MSG_GENERIC,    false,  "can move again.")
MON_MSG(DISEN,				MSG_GENERIC,    false,  "look[s|] less magical!")
MON_MSG(NOT_DISEN,			MSG_GENERIC,    false,  "look[s|] magical again.")
MON_MSG(COMMAND,			MSG_GENERIC,    false,  "fall[s|] under your spell!")
MON_MSG(NOT_COMMAND,		MSG_GENERIC,    false,  "[is|are] no longer under your control.")
MON_MSG(SHAPE_FAIL,			MSG_GENERIC,    false,  "glow[s|] for a moment.")
...
MON_MSG(FREEZE_SHATTER,		MSG_KILL,		false,	"freeze[s|] and shatter[s|] to pieces!")
...
MON_MSG(QUAKE_DEATH,		MSG_KILL,	false,	"[is|are] embedded in the rock!")
MON_MSG(QUAKE_HURT,		MSG_GENERIC,	false,	"moan[s|] in pain!")
