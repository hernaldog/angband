...
{
	{ 0, 0, "Información breve de objetos (obj-desc.spo)", spoiler_menu_act },
	{ 0, 0, "Información breve de artefactos (artifact.spo)", spoiler_menu_act },
	{ 0, 0, "Información breve de monstruos (mon-desc.spo)", spoiler_menu_act },
